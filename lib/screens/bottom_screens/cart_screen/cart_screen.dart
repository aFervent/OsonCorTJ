...
class _CartScreenState extends State<CartScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Consumer<CartProvider>(builder: (context1, value, child) {
      ...
      return value.widget1Opacity == 0.0 ? const CartShimmer(): PopScope(
        canPop: true,
        onPopInvoked: (didPop) {
                              ...
                              child: Column(
                                ...
                                Column(
                                      ...
                                      ...value.cartList
                                          ...
                                          .map((e) => CartLayout(
                                                data: e.value,
                                                infoTap: () => value.addOns(context,data: e.value.serviceList),
                                                editTap: () => value.editCart(
                                                    e.value, context, e.key),
                                                deleteTap: () =>
                                                    value.deleteCartConfirmation(
                                                        context, this, e.key),
                                              )),
                                      Row(
                                        mainAxisAlignment:
