...
class AddOnServiceCart extends StatelessWidget {
  final Services? data;
  const AddOnServiceCart({super.key, this.data,});
          ...
          children: [
            Text(language(context, appFonts.addOns),
                style: appCss.dmDenseMedium14
                    .textColor(appColor(context).darkText)).paddingSymmetric(horizontal: Sizes.s20,vertical: Sizes.s10),
