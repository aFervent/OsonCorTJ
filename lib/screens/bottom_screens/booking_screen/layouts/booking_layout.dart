...
class _BookingLayoutState extends State<BookingLayout> {
  ...
  Widget build(BuildContext context) {
    return Consumer<BookingProvider>(builder: (context1, value, child) {
          ...
          Column(children: [
            ...
            if (widget.data!.bookingStatus!.slug != appFonts.cancelled)
              StatusRow(
                  ...
                  title2:
                      "${((widget.data!.requiredServicemen ?? 1) + (widget.data!.totalExtraServicemen != null ? (widget.data!.totalExtraServicemen ?? 1) : 0))} ${language(context, appFonts.serviceman)}",
            ...
            if (widget.data!.isExpand!)
              ...
              .padding(bottom: Insets.i15, horizontal: Sizes.s20)
      ...
      color: appColor(context).fieldCardBg).center()),
