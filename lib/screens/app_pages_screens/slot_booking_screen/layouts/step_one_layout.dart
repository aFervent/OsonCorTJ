...
class _StepOneLayoutState extends State<StepOneLayout> with SingleTickerProviderStateMixin{
  @override
                      ...
                      children: [
                        ...
                        ...value.servicesCart!.selectedAdditionalServices!
                            ...
                            .map((e) => AddOnServiceCard(
                                  deleteTap: () => value.deleteJobRequestConfirmation(context,this,e.key),
                                  index: e.key,
                                  isDelete: true,
