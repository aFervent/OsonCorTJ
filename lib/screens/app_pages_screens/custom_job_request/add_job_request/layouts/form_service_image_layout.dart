...
class FormServiceImageLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ContainerWithTextLayout(title: language(context, appFonts.chooseImages))
        ...
        (appArray.serviceImageList.isEmpty)
            ...
            : Container(),
        ContainerWithTextLayout(title: language(context, appFonts.title))
            .paddingOnly(top: Insets.i24, bottom: Insets.i12),
        TextFieldCommon(
                focusNode: value.titleFocus,
                controller: value.title,
                hintText: appFonts.enterTitle,
