...
import 'package:fixit_user/widgets/country_picker_custom/country_picker_custom.dart';
        ...
        return SizedBox(
                ...
                child: CountryListPickCustom(
                    appBar: AppBar(
                        ...
                        elevation: 0,
                        backgroundColor: appColor(context).primary),countryBuilder: (context, countryCode) =>
                    Container(
                      height: 50,
                      color: Colors.white,
                      child: Material(
                        ...
                        child: ListTile(
                          ...
                          title: Text(countryCode.name!,style: appCss.dmDenseMedium14.textColor(appColor(context).darkText),),
                          onTap: () {
