        ...
        try {
          ...
          cartList.asMap().entries.forEach((element) {
            if (element.value.isPackage! == false) {
              ...
              if (element.value.serviceList!.selectedAdditionalServices != null &&
                  element.value.serviceList!.selectedAdditionalServices!.isNotEmpty) {
                for (var list in element.value.serviceList!.selectedAdditionalServices!) {
