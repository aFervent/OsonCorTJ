  ...
  if (Platform.isAndroid) {
    ...
    await Firebase.initializeApp(
        ...
        options: const FirebaseOptions(
            apiKey: "AIzaSyDJ0O-mspOscww3qJSHpw22MBIe073JhhE",
            appId: "1:870705367732:android:1f7a18131d320ec11465e1",
            messagingSenderId: "878765367732",
            projectId: "osoncor-c86b7"));
  } else {
    log("app IOS");
    await Firebase.initializeApp(
        name: "Fixit",
